...
public class TextInputs extends javax.swing.JFrame {
  ...
  private void initComponents() {
    ...
    private void signInButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_signInButtonMouseClicked
        // TODO add your handling code here:
      results = 
         playerQueries.getPlayerByUsername(usernameField2.getText(), false);
...
//            game.setPlayersName(usernameField.getText());
    ...
    private void checkButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_checkButtonMouseClicked
      ...
      invalidUsername.setVisible(true);
        if(!checkUsername(usernameField.getText())){
          ...
          checkMarkIconLabel.setIcon(new javax.swing.ImageIcon(getClass().getResource("/proj1/check_mark_100x100.png")));
  ...
  private void passwordField2FocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_passwordField2FocusGained
    ...
    public void setMastermindFrame(JFrame_Mastermind bs){
        game = bs;
    }
    ...
    private boolean checkUsername(String username){
        results = 
         playerQueries.getPlayerByUsername(username, true);
