...
public class Background {
  ...
  public void AnswerGen(int lv, String name){
  ...
  private void AnswerSave(String name){
    try(BufferedWriter writer = new BufferedWriter(new OutputStreamWriter(new FileOutputStream(name.toString()+"Answer.txt"), "UTF-8"))){
      for(int i=0;i<4;i++){
